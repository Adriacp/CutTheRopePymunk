...
with HandLandmarker.create_from_options(options) as landmarker:
  ...
  while cap.isOpened() and running:
    ...
    pygame.draw.circle(screen, (0, 0, 255), (int(body_index.position.x), int(body_index.position.y)), int(circle.radius))
    pygame.draw.circle(screen, (0, 0, 255), (int(body_middle.position.x), int(body_middle.position.y)), int(circle.radius))
    pygame.draw.circle(screen, (0, 0, 255), (int(body_little.position.x), int(body_little.position.y)), int(circle.radius))
    pygame.draw.circle(screen, (0, 0, 255), (int(body_ring.position.x), int(body_ring.position.y)), int(circle.radius))
    pygame.draw.circle(screen, (0, 0, 255), (int(body_thumb.position.x), int(body_thumb.position.y)), int(circle.radius))
